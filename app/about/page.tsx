                ...
                <div className='container mx-auto px-4'>
                    <div className='max-w-4xl mx-auto'>
                        ...
                        <div className='flex flex-col sm:flex-row gap-4 justify-center mt-12'>
                            <Link
                                href='/give/donate'
                                className='bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300 text-center'
                            >
                                Support Our Mission
                            </Link>
                            <Link
                                href='/courses'
                                className='bg-white text-blue-700 border-2 border-blue-700 px-8 py-4 rounded-full text-lg font-semibold hover:bg-blue-50 hover:scale-105 transition-all duration-300 text-center'
                            >
                                Explore Our Courses
                            </Link>
                        </div>
