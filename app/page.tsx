      ...
      <main className="container mx-auto px-4 py-16">
        <div className={`max-w-5xl mx-auto text-center transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 bg-clip-text text-transparent leading-tight">
            Real Skills. Real Careers.<br />
            <span className="text-amber-500">From the Inside.</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
            Free skilled trades education and reentry training for incarcerated learners — 
            <strong className="text-blue-700"> built by people who have been there.</strong>
          </p>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8 rounded-2xl shadow-xl mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              🚀 Coming Soon: A Completely Rebuilt CMTech Experience
            </h2>
            <p className="text-lg md:text-xl opacity-90 max-w-3xl mx-auto">
              We are building something special. A modern, accessible, mobile-first platform 
              that honors the dignity of every learner while showcasing the incredible 
              impact of peer-led education in correctional facilities across America.
            </p>
          </div>
          ...
          <div className="mt-16 p-6 bg-amber-50 border-2 border-amber-300 rounded-xl max-w-2xl mx-auto">
            <p className="text-sm text-amber-800">
              <strong>👋 Hey team!</strong> This is just the beginning. 
              Wait until you see the full course catalog, interactive charter network map, 
              and the learner testimonial section. We are going to blow minds. 🤯
            </p>
